...
#[test]
fn test_list_len() {
    process_example_file("examples/list_len.ml").expect("list_len example failed");
}
...
#[test]
fn test_rbtree() {
    process_example_file("examples/rbtree.ml").expect("rbtree example failed");
}

#[test]
fn test_tree_height() {
    process_example_file("examples/tree_height.ml").expect("tree_height example failed");
}
